...
# Try MP4 (needs ffmpeg in container)
try:
    from matplotlib.animation import FFMpegWriter
    anim.save("/workspace/anim.mp4", writer=FFMpegWriter(fps=10))
    print("Saved /workspace/anim.mp4")
except Exception as e:
    print("MP4 save failed (likely missing ffmpeg):", e)

# Fallback GIF (no ffmpeg; needs Pillow)
try:
    from matplotlib.animation import PillowWriter
    anim.save("/workspace/anim.gif", writer=PillowWriter(fps=10))
    print("Saved /workspace/anim.gif")
except Exception as e:
    print("GIF save failed:", e)

# Standalone HTML snippet (works in any browser)
try:
    html = anim.to_html5_video()
    with open("/workspace/anim.html", "w", encoding="utf-8") as f:
        f.write(html)
    print("Saved /workspace/anim.html")
except Exception as e:
    print("HTML5 video export failed:", e)
